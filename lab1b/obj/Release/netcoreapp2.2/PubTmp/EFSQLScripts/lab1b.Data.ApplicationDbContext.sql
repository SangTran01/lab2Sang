...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190926205314_addedUsers')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190926205314_addedUsers')
BEGIN
    ALTER TABLE [AspNetUsers] ADD [BirthDate] nvarchar(max) NOT NULL DEFAULT N'';
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190926205314_addedUsers', N'2.2.6-servicing-10079');
END;
